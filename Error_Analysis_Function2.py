...
Error_in_time_domain("data_5020_half.csv", "raster_hexadecimal_5020_half.txt", file_length, cutoff, 8, 8, 12, 48)
...
def Plot_in_time_domain(csv_file, txt_file, file_length, cutoff, time_shift_x, time_shift_y, trial_num):
    ...
    plt.plot(actual_data_deg_y_shift[trial_num][4100:4200], label = 'Actual Data', marker = 'o', markersize = 0.1)
    plt.plot(target_data_deg_y_shift[4100:4200], label = 'Target Data', marker = 'x', markersize = 0.1)

    plt.xlabel('Index')
    plt.ylabel('Value')
    plt.legend()
  
Plot_in_time_domain("data_5020_half.csv", "raster_hexadecimal_5020_half.txt", file_length, cutoff, 7, 7, 10)
